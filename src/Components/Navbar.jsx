import {Box,Flex,Image,Input,InputGroup,InputLeftElement,InputRightElement,Text,useDisclosure,useToast,} from "@chakra-ui/react";
      ...
      <Box display={["none", "none", "none", "block"]}  >
        <Box bgColor="#e42529" maxW={"full"} >
          <Flex flexDirection={"row-reverse"} p={2} pr={4}>
            <Flex fontWeight={"semibold"} color={"white"} gap="20px" fontSize={"15px"}>
        ...
        <Box bgColor="#e42529"  >
          ...
          >
            ...
            <Image
              mb={2}
              src="https://i.ibb.co/WkjPYHd/Cart-Bazaar-logo.png"
              alt="logo"
              w="160px"
              ml="50px"
            />
