...
const Carousal = () => {
    ...
    return (
        <div style={{marginTop: isSmallScreen ? "-45px" : "-8px" , marginBottom: isSmallScreen ? 0 : "-30px" }}>
          ...
          <div style={{marginTop: isSmallScreen ? "-20px" : "-30px"  ,marginBottom: isSmallScreen ? "-35px" : "-10px" }}>
            <Slide {...properties}>
