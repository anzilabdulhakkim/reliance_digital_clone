...
const Home = () => {
  return (
    <div>
      ...
      <Box boxShadow=" rgba(0, 0, 0, 0.24) 0px 3px 8px" backgroundColor="white" color="black">
      ...
      <Box h="auto" mt={3} p={5} boxShadow=" rgba(0, 0, 0, 0.24) 0px 3px 8px" backgroundColor="white" color="black">
        <BrandPromise
          type={BrandPromises}
      ...
      <Box boxShadow=" rgba(0, 0, 0, 0.24) 0px 3px 8px" backgroundColor="white" color="black"> 
        <ImageSet
          type={AppleWatch}
          heading="Best Selling Smartwatches"
