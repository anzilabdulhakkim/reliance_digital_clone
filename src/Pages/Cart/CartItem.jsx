...
const CartItem = ({ img, id, name, price, mrp, delivery, handleDelete }) => {
      ...
      <div key={id} className={crt.proinfobox}>
        <div className={crt.productbox} >
          ...
          <div id={crt.mxm}>
            ...
            <h2 id={crt.delivery}> <img src="https://www.reliancedigital.in/build/client/images/standard_delivery_icon.png" width="24px" alt="truck" /> Delivere by: {delivery} </h2>
