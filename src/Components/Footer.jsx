import {Box,Container,Link,SimpleGrid,Stack,Text,Flex,useColorModeValue,Center,Image} from '@chakra-ui/react';
...
export default function Footer() {
  return (
    <Box bg={useColorModeValue('#003380', '#003380')} color={useColorModeValue('white', 'white')}>
      <Container as={Stack} maxW={'8xl'} py={8} >
        <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={8}>
          ...
          <Stack align={'flex-start'}>
            ...
            <Link href={'#'}>About CartBazaar</Link>
    ...
    <SimpleGrid columns={{ base: 1, sm: 1, md: 4 }} spacing={8}>
        ...
        <Stack>
          <Text fontWeight="500" >EXPERIENCE RELIANCE DIGITAL APP ON MOBILE</Text>
          <Flex  gap="2" mt="2" cursor="pointer">
            <Link href="https://play.google.com/store/apps/details?id=in.digital.reliance" isExternal>
              <Image
            ...
            <Link href="https://apps.apple.com/in/app/reliance-digital-shopping-app/id1513379107" isExternal>
              <Image
      ...
      <Center>
        <Text fontSize="14px" p="1">
          {" "}
          © 2024 CartBazaar . All Rights Reserved.
        </Text>
      </Center>
    </Box>
    </Box>
