...
import { getPosts, getPostsComputer, getPostsHeadPhone, getPostsMobile, getPostsTelevisions } from "../../Redux/Products/Product.action";
          ...
          {skeletonLoading ? (
            ...
            <div id="productCards">
              {data.map((product, index) => (
                <Link key={index+2} to={`computers/${product.id}`}>
                  <Card
                    variant="outline"
                    key={product.id}
                    _hover={{
